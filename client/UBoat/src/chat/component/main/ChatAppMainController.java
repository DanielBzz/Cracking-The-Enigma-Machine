...
import chat.component.chatroom.ChatRoomMainController;
...
public class ChatAppMainController implements Closeable, HttpStatusUpdate {
    ...
    public ChatAppMainController() {
        currentUserName = new SimpleStringProperty(Constants.JHON_DOE);
    }
...
//    }
    ...
    private void loadChatRoomPage() {
        URL loginPageUrl = getClass().getResource(Constants.CHAT_ROOM_FXML_RESOURCE_LOCATION);
        try {
            FXMLLoader fxmlLoader = new FXMLLoader();
            fxmlLoader.setLocation(loginPageUrl);
    ...
    public void switchToLogin() {
        Platform.runLater(() -> {
            currentUserName.set(Constants.JHON_DOE);
