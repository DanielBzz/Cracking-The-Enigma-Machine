...
public class Constants {
    ...
    public final static String MAIN_PAGE_FXML_RESOURCE_LOCATION = "/chat/component/main/uBoat-app-main.fxml";
    public final static String LOGIN_PAGE_FXML_RESOURCE_LOCATION = "/chat/component/login/login.fxml";
    public final static String CHAT_ROOM_FXML_RESOURCE_LOCATION = "/chat/component/chatroom/chat-room-main.fxml";
    public final static String UBOAT_ROOM_FXML_RESOURCE_LOCATION = "/chat/component/chatroom/uBoat-room-main.fxml";
